...
/**
 * @version $Id: ASTBitwiseAndNode.java,v 1.3 2010/07/29 10:09:22 olga Exp $
 * @author $Author: olga $
 */
public class ASTBitwiseAndNode extends NUMxNUMtoNUMnode {

	static final long serialVersionUID = 1L;

	ASTBitwiseAndNode(String id) {
		super(id);
	}

	public static Node jjtCreate(String id) {
		return new ASTBitwiseAndNode(id);
	}
 ...
 * 
 * Revision 1.6 2000/04/05 12:09:47 shultzke serialVersionUID aus V1.0.0
 * generiert
 * 
 * Revision 1.5 2000/03/14 10:58:48 shultzke Transformieren von Variablen auf
